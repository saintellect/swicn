    ...
    GlassCase.prototype = {
        init: function (options) {
            ...
            var ctntDisplayArea = "<div class='gc-display-area'>" +
                                        ...
                                        "<div class='gc-icon gc-icon-next'><i class='fas fa-chevron-right'></i></div>" +
                                        "<div class='gc-icon gc-icon-prev'><i class='fas fa-chevron-left'></i></div>" +
            ...
            var ctntOverlayArea = "<div class='gc-overlay-area'>" +
                                    "<div class='gc-overlay-top-icons'>" +
                                     "<div class='gc-icon gc-icon-close'><i class='far fa-times-circle'></i> </div>" +
                                        "<div class='gc-icon gc-icon-enlarge'> <i class='fas fa-search-plus'></i></div>" +
            ...
            var ctntThumbsPrevNext = "<div class='gc-thumbs-area-prev'><div class='gc-icon gc-icon-prev" + sVT + "'><i class='fas fa-chevron-left'></i></div></div>" +
                                     "<div class='gc-thumbs-area-next'><div class='gc-icon gc-icon-next" + sVT + "'><i class='fas fa-chevron-right'></i></div></div>";
